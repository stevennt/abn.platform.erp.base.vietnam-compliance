...
from vietnam_compliance.vat_vietnam.setup import after_install as setup_gst
...
def after_install():
    try:
        ...
        pass  # TODO: Vietnam income tax setup removed
...
def run_post_install_patches():
    ...
    try:
        for patch in POST_INSTALL_PATCHES:
            frappe.get_attr(f "vietnam_compliance.patches.post_install.{patch}.execute")()
