...
vietnam_compliance.FILTER_OPERATORS = {
...
class _Filter extends frappe.ui.Filter {
    set_conditions_from_config() {
        ...
        this.conditions = this.conditions.filter(
            (condition) => vietnam_compliance.FILTER_OPERATORS[condition && condition[0]],
        );
    }
}

vietnam_compliance.FilterGroup = class FilterGroup extends frappe.ui.FilterGroup {
    constructor(opts) {
        if (!opts.parent) frappe.throw(__("vietnam_compliance.FilterGroup: Parent element not found"));
