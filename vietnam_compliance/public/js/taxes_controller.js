...
frappe.provide("vietnam_compliance.taxes_controller_events");

vietnam_compliance.taxes_controller = class TaxesController {
    ...
    async set_item_wise_tax_rates(item_name, tax_name) {
        ...
        await frappe.call({
            method: "vietnam_compliance.vat_vietnam.utils.taxes_controller.set_item_wise_tax_rates",
            args: {
                doc: this.frm.doc,
                item_name: item_name,
                tax_name: tax_name,
...
Object.assign(vietnam_compliance.taxes_controller_events, {
