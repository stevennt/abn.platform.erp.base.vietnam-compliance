export async function get_details(type) {
    return vietnam_compliance.gst_api.call(`account.get_${type}_details`, {
        method: "GET",
...
export async function update_billing_details(new_billing_details) {
    return vietnam_compliance.gst_api.call("account.update_billing_details", {
        method: "POST",
...
export async function create_order(credits, amount) {
    return vietnam_compliance.gst_api.call("account.create_order", {
        method: "POST",
        body: { credits, amount },
        with_api_secret: true,
    });
...
export async function verify_payment(orderId) {
    return vietnam_compliance.gst_api.call("account.verify_payment", {
        method: "POST",
...
export async function get_invoice_history(from_date, to_date) {
    return vietnam_compliance.gst_api.call("account.get_invoice_history", {
        method: "POST",
...
export async function send_invoice_email(invoice_name, email) {
    return vietnam_compliance.gst_api.call("account.send_invoice_email", {
        method: "POST",
