...
frappe.provide("vietnam_compliance.pages");
vietnam_compliance.pages.IndiaComplianceAccountPage = IndiaComplianceAccountPage;

frappe.provide("vietnam_compliance.gst_api");
vietnam_compliance.gst_api.call = async function (endpoint, options) {
    try {
