class GSTQuickEntryForm extends frappe.ui.form.QuickEntryForm {
    constructor(...args) {
        ...
        this.api_enabled = vietnam_compliance.is_api_enabled() && gst_settings.autofill_party_info;
    ...
    render_dialog() {
        super.render_dialog();
        vietnam_compliance.set_state_options(this.dialog);
    }
        ...
        return [
            {
                ...
                onchange: () => {
                    ...
                    vietnam_compliance.check_duplicate_gstin(d.doc._gstin, this.doctype);
                    ...
                    d.set_value(
                        "gst_category",
                        vietnam_compliance.guess_gst_category(d.doc._gstin, d.doc.country),
                    );
                },
            },
        ];
            ...
            },
            {
                ...
                onchange: async () => {
                    ...
                    const { message: gstin_list } = await frappe.call(
                        "vietnam_compliance.vat_vietnam.utils.get_gstin_list",
...
class ItemQuickEntryForm extends frappe.ui.form.QuickEntryForm {
    render_dialog() {
        super.render_dialog();
        vietnam_compliance.set_hsn_code_query(this.dialog.get_field("gst_hsn_code"));
...
function set_gstin_description(gstin_field, status) {
    ...
    gstin_field.set_description(vietnam_compliance.get_gstin_status_desc(status));
}
...
function get_gstin_info(gstin, doctype, throw_error = true) {
    return frappe
        .call({
            method: "vietnam_compliance.vat_vietnam.utils.gstin_info.get_gstin_info",
