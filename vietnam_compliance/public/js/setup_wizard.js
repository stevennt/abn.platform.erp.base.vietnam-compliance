frappe.require("assets/vietnam_compliance/js/quick_entry.js");
...
function complete_setup_wizard() {
    frappe.call({
        method: "vietnam_compliance.setup_wizard.enable_setup_wizard_complete",
        callback: function (r) {
...
async function autofill_company_info(slide) {
    ...
    if (!vietnam_compliance.validate_gstin(gstin)) {
...
function can_fetch_gstin_info() {
    return vietnam_compliance.is_api_enabled() && !frappe.boot.gst_settings.sandbox_mode;
}
