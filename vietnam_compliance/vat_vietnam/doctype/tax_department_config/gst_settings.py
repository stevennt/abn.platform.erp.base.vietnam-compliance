# TODO: Rewrite as TaxDepartmentConfig in GP-GOAL-003
import frappe
...
from vietnam_compliance.vat_vietnam.utils.gstin_info import get_gstin_info
from vietnam_compliance.utils.custom_fields import toggle_custom_fields
...
class GSTSettings(Document):
    ...
    def update_e_invoice_status(self):
        ...
        if not (has_value_changed or not self.is_child_table_same("e_invoice_applicable_companies")):
            return
    ...
    def update_retry_e_invoice_e_waybill_scheduled_job(self):
        ...
        frappe.db.set_value(
            "Scheduled Job Type",
            {"method": "vietnam_compliance.vat_vietnam.utils.e_invoice.retry_e_invoice_e_waybill_generation"},
            "stopped",
    ...
    def update_auto_refresh_authtoken_scheduled_job(self):
        ...
        frappe.db.set_value(
            "Scheduled Job Type",
            {
                "method": "vietnam_compliance.vat_vietnam.doctype.purchase_reconciliation_tool.purchase_reconciliation_tool.auto_refresh_authtoken"
            },
            "stopped",
    ...
    def validate_e_invoice_applicability_date(self):
        ...
        if not self.e_invoice_applicable_from and not self.apply_e_invoice_only_for_selected_companies:
            frappe.throw(
