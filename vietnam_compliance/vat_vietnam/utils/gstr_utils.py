...
from vietnam_compliance.vat_vietnam.api_classes.taxpayer_returns import IMSAPI, ReturnsAPI
from vietnam_compliance.vat_vietnam.doctype.gstr_import_log.gstr_import_log import (
    create_import_log,
    toggle_scheduled_jobs,
)
from vietnam_compliance.vat_vietnam.utils import create_notification
from vietnam_compliance.vat_vietnam.utils.gstr_1.gstr_1_download import (
...
def _download_queued_request(doc):
    from vietnam_compliance.vat_vietnam.utils.gstr_2 import (
        _download_gstr_2a,
        save_gstr_2b,
        save_ims_invoices,
    )
