...
from vietnam_compliance.vat_vietnam.utils import validate_pincode
...
class TestUtils(IntegrationTestCase):
    ...
    @patch("vietnam_compliance.vat_vietnam.utils.getdate", return_value=getdate("2023-06-20"))
    def test_timespan_date_range(self, getdate_mock):
        from vietnam_compliance.vat_vietnam.utils import get_timespan_date_range
