...
from vietnam_compliance.vat_vietnam.api_classes.taxpayer_base import otp_handler
from vietnam_compliance.vat_vietnam.api_classes.taxpayer_e_invoice import (
...
from vietnam_compliance.vat_vietnam.constants.e_invoice import (
    CANCEL_REASON_CODES,
    ITEM_LIMIT,
)
from vietnam_compliance.vat_vietnam.doctype.gst_settings.gst_settings import (
    get_e_invoice_applicability_date,
)
from vietnam_compliance.vat_vietnam.overrides.transaction import validate_mandatory_fields
from vietnam_compliance.vat_vietnam.utils import (
    are_goods_supplied,
