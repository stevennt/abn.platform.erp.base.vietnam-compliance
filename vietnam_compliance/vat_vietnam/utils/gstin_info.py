...
from vietnam_compliance.exceptions import GSPServerError
from vietnam_compliance.vat_vietnam.api_classes.base import BASE_URL
from vietnam_compliance.vat_vietnam.api_classes.nic.e_invoice import EInvoiceAPI
from vietnam_compliance.vat_vietnam.api_classes.nic.e_waybill import EWaybillAPI
from vietnam_compliance.vat_vietnam.api_classes.public import PublicAPI
from vietnam_compliance.vat_vietnam.api_classes.taxpayer_base import (
    otp_handler,
)
from vietnam_compliance.vat_vietnam.api_classes.taxpayer_returns import GSTR1API
from vietnam_compliance.vat_vietnam.utils import parse_datetime, titlecase, validate_gstin
...
def _get_gstin_info(gstin, *, doc=None, throw_error=True):
    ...
    if not response:
        try:
            ...
            frappe.enqueue(
                "vietnam_compliance.vat_vietnam.doctype.gstin.gstin.create_or_update_gstin_status",
                queue="long",
...
def update_gstr_returns_info(company, gstin, fy=None):
    ...
    from vietnam_compliance.vat_vietnam.doctype.gst_return_log.gst_return_log import (
...
def create_or_update_logs_for_year(gstin, period, response):
    ...
    # patch
    from vietnam_compliance.patches.v15.update_return_logs_with_filing_preference import (
