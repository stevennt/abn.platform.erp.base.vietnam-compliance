...
from vietnam_compliance.vat_vietnam.utils import get_place_of_supply_options
...
CUSTOM_FIELDS = {
    ...
    "Subcontracting Order": [
        {
            ...
            "insert_after": "total",
            "hide_border": 1,
            "depends_on": "eval: doc.purchase_order && vietnam_compliance.is_e_waybill_applicable_for_subcontracting(doc)",
        },
    ],
    "Subcontracting Receipt": [
        {
            ...
            "insert_after": "total",
            "hide_border": 1,
            "depends_on": "eval: vietnam_compliance.is_e_waybill_applicable_for_subcontracting(doc)",
        },
        {
    ...
    "Tax Category": [
        {
            "fieldname": "is_vietnam_compliance_default",
        ...
        },
        {
            ...
            "fieldtype": "Check",
            "insert_after": "is_vietnam_compliance_default",
            "print_hide": 1,
        },
        {
