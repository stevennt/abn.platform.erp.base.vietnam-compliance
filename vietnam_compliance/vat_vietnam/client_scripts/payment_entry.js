...
frappe.ui.form.on("Payment Entry", {
    ...
    party(frm) {
        update_gst_details(frm, "vietnam_compliance.vat_vietnam.overrides.payment_entry.update_party_details");
    },
...
async function update_gst_details(frm, method) {
    ...
    vietnam_compliance.fetch_and_update_gst_details(frm, args, method);
}
