...
frappe.ui.form.on(DOCTYPE, {
    ...
    setup(frm) {
        ...
        frm.set_query("print_label", "bank_details_for_printing", (_, cdt, cdn) => {
            return {
                query: "vietnam_compliance.vat_vietnam.overrides.company.get_default_print_options",
                params: { for_bank: 1 },
            };
        });
    ...
    make_default_tax_template: function (frm) {
        ...
        frappe.call({
            method: "vietnam_compliance.vat_vietnam.overrides.company.make_default_tax_templates",
