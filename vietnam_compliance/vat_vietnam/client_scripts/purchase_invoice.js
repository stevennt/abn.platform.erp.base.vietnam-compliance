...
frappe.ui.form.on(DOCTYPE, {
    setup(frm) {
        ...
        vietnam_compliance.setup_itc_claim_period_query(frm);
    },
    ...
    refresh(frm) {
        vietnam_compliance.set_reconciliation_status(frm, "bill_no");
        vietnam_compliance.set_itc_claim_period_status(frm);
            ...
            frm.add_custom_button(
                ...
                () => {
                    frappe.model.open_mapped_doc({
                        method: "vietnam_compliance.vat_vietnam.doctype.bill_of_entry.bill_of_entry.make_bill_of_entry",
                        frm: frm,
                    });
                },
                __("Create"),
