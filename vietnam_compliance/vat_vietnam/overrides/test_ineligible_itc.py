...
from vietnam_compliance.vat_vietnam.doctype.bill_of_entry.bill_of_entry import (
    make_bill_of_entry,
    make_landed_cost_voucher,
)
from vietnam_compliance.vat_vietnam.utils.tests import create_transaction
