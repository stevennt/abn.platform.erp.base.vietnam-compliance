...
from vietnam_compliance.vat_vietnam.constants import VALID_HSN_LENGTHS
from vietnam_compliance.vat_vietnam.overrides.payment_entry import get_taxes_summary
from vietnam_compliance.vat_vietnam.overrides.transaction import (
    _validate_hsn_codes,
...
from vietnam_compliance.vat_vietnam.overrides.unreconcile_payment import (
...
from vietnam_compliance.vat_vietnam.utils.transaction_data import (
...
def on_submit(doc, method=None):
    ...
    if (
        ...
        frappe.enqueue(
            "vietnam_compliance.vat_vietnam.utils.e_waybill.generate_e_waybill",
            enqueue_after_commit=True,
            queue="short",
            doctype=doc.doctype,
            docname=doc.name,
